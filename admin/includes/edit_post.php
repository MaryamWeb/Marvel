...
<?php
 if(isset($_POST['update'])){
    ...
    if(empty($error)){
        ...
        $success_message ="<div class='alert alert-success' role='alert'> Post has been succefully updated <a href= '/marvel/post/{$post_id}'  class='alert-link'> Click here to view the post</a> or
