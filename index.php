...
<div class="container py-3 text-break" >
    <div class="row">
        ...
        <?php 
            $result=  query("SELECT * FROM posts INNER JOIN users ON users.user_id = posts.user_name_id ORDER BY posts.post_id DESC LIMIT {$start},$per_page");
        ...
        <?php include "includes/index_pagination.php"; ?> 
        </section> 
