...
<?php
 if(isset($_POST['publish'])){
    ...
    if(empty($error)){
        ...
        $success_message= "<div class='alert alert-success' role='alert'>Post has been succefully added <a href= '/marvel/post/{$post_id}'  class='alert-link'> Click here to check the post</a> or
